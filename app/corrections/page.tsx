...
const LOG: { date: string; kind: "更新" | "訂正"; text: string }[] = [
  { date: "2026-09-25", kind: "更新", text: "見やすさと使いやすさを改善：詳細ページのデザインを統一（小見出しを日本語に）、メニューに「選挙と投票」を追加、議員ページに「次の選挙」を表示、図解「あなたが選べる人」「県と市、どっちが何をしている？」を追加、投票日までの残り日数を表示、知事選ページに立候補者の掲載欄（告示後に選挙管理委員会の発表をもとに掲載）を用意。" },
  { date: "2026-09-25", kind: "更新", text: "新しい争点「副首都」を追加（2026年7月成立の副首都法、愛知県・名古屋市の指定に向けた動き、賛否それぞれの論点を国会会議録・県の資料から）。参議院の押しボタン投票を、第221回国会のすべての案件（120件）について愛知選出の参院議員8人分収録。防災（9月8日の大雨）とアジア大会（開幕）の現状、名古屋市民税減税の2026年度の状況、知事選ページの「決まっていること・まだ決まっていないこと」を更新。用語集に副首都・被選挙権・直接請求・与党と野党を追加。" },
