...
export const GLOSSARY: GlossaryTerm[] = [
  ...
  { id: "futai", term: "附帯決議", yomi: "ふたいけつぎ", short: "議案を可決するときに、議会が「この点に配慮して進めて」と条件や要望を付けて示す決議。法的拘束力はないが行政への意思表示になる。", seeAlso: ["saiketsu", "gikai"] },
  { id: "shusei-kaketsu", term: "修正可決", yomi: "しゅうせいかけつ", short: "首長などが出した議案を、議会が一部修正したうえで可決すること。議会のチェック機能が働いた形のひとつ。", seeAlso: ["nigen", "futai"] },
  { id: "teireikai", term: "定例会・臨時会", yomi: "ていれいかい・りんじかい", short: "議会が開かれる期間（会期）。定例会は年に数回（県・名古屋市は年4回程度）定期的に、臨時会は必要に応じて開かれる。", seeAlso: ["gikai"] },
  { id: "seigan", term: "請願・陳情", yomi: "せいがん・ちんじょう", short: "住民が議会に「こうしてほしい」と直接求めるしくみ。請願は議員の紹介が必要で、採択されると行政に送られる。", seeAlso: ["gikai"] },
  { id: "ikensho", term: "意見書", yomi: "いけんしょ", short: "地方議会が国などに「この問題に取り組んで」と公式に意見を伝える文書。地方自治法に基づく。", seeAlso: ["gikai"] },
  { id: "seimukatsudohi", term: "政務活動費", yomi: "せいむかつどうひ", short: "議員の調査研究など議員活動のために、議会から会派や議員に交付されるお金。使いみちは公開対象。", seeAlso: ["kaiha", "seijishikin"] },
  { id: "daihyo-shitsumon", term: "代表質問・一般質問", yomi: "だいひょうしつもん・いっぱんしつもん", short: "議員が本会議で首長や行政に方針をただす質問。代表質問は会派を代表して、一般質問は議員個人として行う。", seeAlso: ["kaiha", "gikai"] },
